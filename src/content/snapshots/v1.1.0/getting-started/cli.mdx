...
CLI and framework packages are synchronized stable `1.1.0` releases published
on npm. Install this snapshot's CLI with:

```sh
pnpm add --save-dev @combric/cli@1.1.0
```
...
public Combric packages, including `@combric/cli@1.1.0`, are published; normal
